...
export default function HomeHowWeHelp() {
  return (
    <div className="px:0 flex w-full flex-col py-8 text-center md:py-16 xl:px-32">
      <h2 className="pb-16 text-3xl font-bold text-gray-900 dark:text-gray-50">
        How do we help you?
      </h2>

      <div className="gap-2h-[480px] grid w-full grid-cols-1 gap-4 md:grid-cols-2">
        <div className="mb-4 flex flex-col items-center justify-center text-left md:mb-0">
          <div className="flex h-80 w-full flex-col rounded-lg p-8 dark:bg-dark-gray md:h-72 md:p-14 xl:w-[480px]">
